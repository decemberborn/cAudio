...
macro(copy_debug INPUT)
	configure_file(${CAUDIO_DEPENDENCIES_DIR}/bin/debug/${INPUT} ${CMAKE_BINARY_DIR} COPYONLY)
endmacro()

macro(copy_release INPUT)
  configure_file(${CAUDIO_DEPENDENCIES_DIR}/bin/release/${INPUT} ${CMAKE_BINARY_DIR} COPYONLY)
endmacro ()
